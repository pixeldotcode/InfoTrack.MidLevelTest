...
namespace WebApplication.Infrastructure.Services
{
    public class UserService : IUserService
    {
        ...
        {
            return await _dbContext.Users.Where(user => user.GivenNames == givenNames || user.LastName == lastName).ToListAsync();
        ...
        {
            return await _dbContext.Users.Skip(page* count).Take(count).ToListAsync();
